...
class EndlessGameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        size = CGSize(width: 1000, height: 1835)
    ...
    func accelerateBall(body: SKPhysicsBody) {
        ...
        let accelerationFactor: CGFloat = 1.1
    ...
    private func loseAction() {
        ...
        isPaused = true
        NotificationCenter.default.post(name: Notification.Name("game_over"), object: nil, userInfo: ["credits": balance])
    }
